...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIStoryboard *str = [UIStoryboard storyboardWithName:@"fankai" bundle:nil];
    UIViewController *lave = [str instantiateViewControllerWithIdentifier:@"ViewController"];

    
    [self.window.rootViewController presentViewController:lave animated:YES completion:nil];
